  ...
  return (
    ...
    >
      <div className="container-fluid px-3 px-sm-4 px-md-5">
        <div className="d-flex align-items-center justify-content-between py-3 py-sm-3">
          <div className="admin-navbar-content fade-up d-flex align-items-center gap-3">
            <div 
              style={{
                width: '4px',
                height: '40px',
            ...
            <div>
              ...
              <p className="mb-0 small text-muted" style={{ fontSize: '0.75rem', marginTop: '-2px' }}>
                Welcome back, Admin
              </p>
            </div>
          </div>
          ...
          <div className="d-flex align-items-center gap-2 gap-sm-3 gap-md-4">
            {/* Search Button */}
            <button
              className="btn position-relative p-2 text-decoration-none rounded-3 admin-search-btn"
              aria-label="Search"
              style={{ 
            ...
            >
              <FontAwesomeIcon icon={faSearch} style={{ fontSize: '0.95rem' }} />
            </button>

            {/* Notifications Button */}
            <button
              className="btn position-relative p-2 text-decoration-none rounded-3 admin-notification-btn admin-notification-btn-enhanced"
            ...
            >
              <FontAwesomeIcon icon={faBell} className="admin-bell-icon" style={{ fontSize: '1rem' }} />
              <span 
            ...
            {/* Settings Button */}
            <button
              className="btn position-relative p-2 text-decoration-none rounded-3 admin-settings-btn"
              aria-label="Settings"
              style={{ 
                background: 'linear-gradient(135deg, rgba(45, 80, 22, 0.05) 0%, rgba(34, 197, 94, 0.05) 100%)',
                border: '1px solid rgba(45, 80, 22, 0.1)',
            ...
            >
              <FontAwesomeIcon icon={faCog} style={{ fontSize: '0.95rem' }} />
            </button>

            {/* User Profile */}
            <div 
              className="d-flex align-items-center gap-2 gap-sm-3 admin-user-profile rounded-3 px-2 py-1"
              style={{
            ...
            >
              <div 
                className="admin-user-avatar-wrapper rounded-circle d-flex align-items-center justify-content-center"
                style={{
                  width: '40px',
                  height: '40px',
                  background: 'linear-gradient(135deg, #2D5016 0%, #22C55E 100%)',
              ...
              <div className="d-none d-md-block fade-up fade-delay-1">
                <div 
